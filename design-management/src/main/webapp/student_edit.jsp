...
<script type="text/javascript">
	...
	function edit(){
		var v = window.confirm("您确定要修改该学生信息吗？");
		if(v){
			 $("#addForm").submit(); 	 
		} 
...
<body>
	<div class="x-body">
	<form class="layui-form" id="addForm" action="${pageContext.request.contextPath }/student_edit.html" method="post" target="_parent">
		<form  class="layui-form">
			...
			<input type="hidden" id="choose" value="${personal.teacher_number }">
			<div class="layui-form-item">
			    <label class="layui-form-label">指导老师</label>
			    <div class="layui-input-block">
			      <select id="chooseTeacher" name="teacher_number" lay-verify="required">
			      </select>
			    </div>
			  </div>
