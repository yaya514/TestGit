...
<script type="text/javascript">
	function edit(){
		var v = window.confirm("您确定要修改该您的信息吗？");
		if(v){
			 $("#addForm").submit(); 	 
		} 
...
<body>
	<div class="x-body">
		<form id="addForm" class="layui-form" action="${pageContext.request.contextPath }/teacher_editTeacher.html" method="post" target="_parent">
			
			<div class="layui-form-item">
				<label for="L_username" class="layui-form-label"> 工号 </label>
				<div class="layui-input-inline">
					<input type="text" id="" name="teacher_number" value="${personal.teacher_number }"  style="color: blue"
			...
			<div class="layui-form-item">
				...
				<div class="layui-input-inline">
					<input type="text" id="L_username" name="teacher_name" value="${personal.teacher_name }" required
			...
			<div class="layui-form-item">
				...
				<div class="layui-input-inline">
					<input type="text" id="L_city" name="teach_course" value="${personal.teach_course }" autocomplete="off"
					 class="layui-input">
				</div>
			</div>
