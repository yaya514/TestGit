...
<script type="text/javascript">
	...
	function addStudent(){
		var v = window.confirm("您确定要添加该学生信息吗？");
		if(v){
			 $("#addForm").submit(); 	 
		} 
...
<body>
	<div class="x-body">
		<form id="addForm" class="layui-form" action="${pageContext.request.contextPath }/student_add.html" method="post">
			
			<div class="layui-form-item">
				<label for="L_username" class="layui-form-label"> 学号 </label>
				<div class="layui-input-inline">
					<input type="text" id="" name="student_number" style="color: blue"
			...
			<div class="layui-form-item">
				...
				<div class="layui-input-inline">
					<input type="text" id="L_city" name="profession" value="" autocomplete="off"
					 class="layui-input">
				</div>
			</div>
			...
			<div class="layui-form-item">
				...
				<input type="button" class="layui-btn" value="添加" onclick="addStudent()"/>
			</div>
		</form>
	</div>
