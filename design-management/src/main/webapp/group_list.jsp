...
<script type="text/javascript">
	...
	function addGroup(){
		location.href = "${pageContext.request.contextPath }/group_add.jsp";
	}
	
	function deleteAll(){
		var confirm = window.confirm("您确定要删除选中的小组吗？");
		if(confirm){
			$("#form").submit();
		}
}
...
<body>
	<form id="form"
		...
		<div class="x-body" style="height: 1050px; width: 1113px">
			...
			</a> <a class="layui-btn" onclick="addGroup()"> <i class="layui-icon">&#xe608;</i>添加
			</a>
				...
				<c:forEach items="${page.list }" var="group" varStatus="vs">
					<tbody id="x-img${group.group_id }">
						<tr>
							...
							<td class="td-manage">
								<%-- <a title="编辑学生成员" href="javascript:;"
									onclick="member_edit('编辑','group_show.html','${group.group_id}','','510')"
									class="ml-5" style="text-decoration: none">
										<span style="color: blue"></span>
									 <i class="layui-icon" style="font-size: 25px; color: blue">&#xe642;</i>
								</a>  --%>
								<a title="删除" href="javascript:;"
									onclick="deleteGroup(${group.group_id})" style="text-decoration: none">
