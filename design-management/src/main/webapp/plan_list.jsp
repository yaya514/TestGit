...
<script type="text/javascript">
	function changePage(currentPage){
		location.href = "${pageContext.request.contextPath }/plan_list.html?currentPage="+ currentPage;
	}
...
<body>
	<form id="form"
		...
		<div class="x-body" style="height: 1050px; width: 1113px">
			...
			</a> <a class="layui-btn" onclick="addPlan()"> <i class="layui-icon">&#xe608;</i>添加
			</a>
						...
						<tr>
							...
							<td class="td-manage">
								<a title="编辑" href="javascript:;"
									onclick="member_edit('编辑','plan_show.html','${plan.plan_id}','','510')"
									class="ml-5" style="text-decoration: none"> <i
										class="layui-icon" style="font-size: 25px; color: blue">&#xe642;</i>
								</a> 
								<a title="删除" href="javascript:;"
									onclick="deletePlan(${plan.plan_id})" style="text-decoration: none">
