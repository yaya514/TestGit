...
<body>
	<div class="x-body">
		<form id="editForm" class="layui-form" action="${pageContext.request.contextPath }/student_password.html" method="post" target="_parent">
			<input type="hidden" name="student_id" value="${personal.student_id }">
			<div class="layui-form-item">
				<label for="L_username" class="layui-form-label"> 账号 </label>
				<div class="layui-input-inline">
					<input type="text" id="" name="student_number" readonly="readonly" style="color: blue"
						lay-verify="required" autocomplete="off" value="${personal.student_number }"
						class="layui-input">
				</div>
			</div>
