...
<script type="text/javascript">
	...
	function resetGroup(){
		...
		if(v){
			location.href = "${pageContext.request.contextPath }/group_resetTeacher.html";
		}
	}
	...
	function chooseGroup(group_id){
		...
		if(confirm){
			location.href = "${pageContext.request.contextPath }/group_chooseTeacher.html?group_id="+group_id;
		}
}
</script>
						...
						<tr>
							...
							<td>
								<c:forEach items="${group.teacherList }" var="teacher">
									<c:if test="${teacher.teacher_name == personal.teacher_name}">
										<i style="font-size: 17px; color: blue">${teacher.teacher_name };</i>
									</c:if>
									<c:if test="${teacher.teacher_name != personal.teacher_name}">
