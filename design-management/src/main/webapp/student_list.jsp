...
<script type="text/javascript">
	...
	function deleteStudent(number){
		var v = window.confirm("您确定要删除该学生信息吗？");
		if(v){
			location.href = "${pageContext.request.contextPath }/student_delete.html?number="+number;
		}
	}
	...
	function addStudent(){
		location.href = "${pageContext.request.contextPath }/student_add.jsp";
	}
...
<body>
	<form id="form"
		...
		<div class="x-body" style="height: 1050px; width: 1113px">
			...
			</a> <a class="layui-btn" onclick="addStudent()"> <i class="layui-icon">&#xe608;</i>添加
			</a>
